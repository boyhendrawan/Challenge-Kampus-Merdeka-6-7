...
function Login() {
  ...
  const handlerSubmit = (e) => {
    e.preventDefault();
    if (valueUsername.length <= 0 || valuePassword.length <= 0) return toast.info("hello", { position: toast.POSITION.TOP_CENTER });
    dispatch(requestLogin({ valueUsername, valuePassword }, navigate, resetUsername, resetPassword));
  }
  return (
    <>
          ...
          <div className='bg-slate-50 shadow-md p-5 rounded-lg w-full max-w-lg '>
            ...
            <form onSubmit={handlerSubmit}>
              ...
              <div className='flex flex-col w-full h-full'>
                ...
                <input type='password' name="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  focus:outline-none focus:ring-2 focus:ring-blue-600 block w-full p-2.5 " onChange={handleChangePassword} onBlur={handleBlurPassword} value={valuePassword} placeholder="put your Password.." />
            ...
            <p className='text-center mb-5 mt-3'>Login with </p>
            <div className='grid grid-cols-1 justify-items-center gap-x-4 w-full'>
              ...
              <p className='text-center mb-5 mt-3'>Don't have Account ? <span> <Link className='text-blue-500 hover:text-blue-800' to="/register">Register</Link></span></p>
