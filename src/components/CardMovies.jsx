  ...
  const defaultImg="https://www.themoviedb.org/assets/2/v4/glyphicons/basic/glyphicons-basic-38-picture-grey-c2ebdbb057f2a7614185931650f8cee23fa137b93812ccb132b9df511df1cfac.svg";
    return (
        <>
            {
               data?.map((e, i) => {
                    return (<div className=" card" key={i} style={{ backgroundImage: `url(${(e?.backdrop_path) ? path500 + e?.backdrop_path : defaultImg})` }} >
                        <div className='w-full h-full bg-gradient-to-b from-transparent rounded-lg to-black  flex items-end justify-center'>
                            <h1 className='mb-4 text-sm font-bold capitalize text-center'>e{e?.original_title}</h1>
                        </div>
                        <div className='card-more-info'>
                            <Link to={`/movies/detail/${e.id}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 text-btnColor">
